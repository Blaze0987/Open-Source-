...
\x1b[35m╠══[TOOLS                    • PAID ]         ║
\x1b[33m╠══[VERSION                  • 15.7 ]         ║
\x1b[92m╠══[Key:\x1b[1;35m         I'M TUTUL BOKACHODA           \x1b[0;33m║
\x1b[34m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝"""
os.system('clear')
print(logo)
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\x1b[10;97m{bo}[Tutul•XD]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\x1b[10;92m "),
    sys.stdout.flush()
