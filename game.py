...
def file_subb(Gmail,psslist):
    ...
    try:
        for ps in psslist:
            user_agent="[FBAN/FB4A;FBAV/30.0.0.19.17;FBBV/8445415;FBDM/{density=1.0,width=600,height=976};FBLC/en_US;FBCR/null;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-M105F;FBSV/8.1.0;FBOP/11;FBCA/armeabi-v7a:armeabi;]"
            data={
            'adid': str(uuid.uuid4()),
            'format': 'json',
